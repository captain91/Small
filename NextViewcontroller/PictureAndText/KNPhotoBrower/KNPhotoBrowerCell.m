...
- (void)sd_ImageWithUrl:(NSString *)url placeHolder:(UIImage *)placeHolder isUrl:(BOOL)isUrl{
    [_photoBrowerImageView sd_ImageWithUrl:[NSURL URLWithString:url] placeHolder:placeHolder isUrl:isUrl];
}
